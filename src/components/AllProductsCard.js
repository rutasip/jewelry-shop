...
const productImages = [
  ...
  require("../assets/products/2/1.jpg"),
  require("../assets/products/2/2.jpg"),
  require("../assets/products/2/3.jpg"),
  require("../assets/products/2/4.jpg"),
  require("../assets/products/2/5.jpg"),
  require("../assets/products/3/1.jpg"),
  require("../assets/products/3/2.jpg"),
  require("../assets/products/3/3.jpg"),
  require("../assets/products/3/4.jpg"),
  require("../assets/products/3/5.jpg"),
  require("../assets/products/3/6.jpg"),
  require("../assets/products/3/7.jpg"),
  require("../assets/products/3/8.jpg"),
  require("../assets/products/3/9.jpg"),
  require("../assets/products/3/10.jpg"),
  require("../assets/products/3/11.jpg"),
]
